...
@implementation APActivity
@synthesize startDate;
@synthesize phoneInvitees;
@synthesize emailInvitees;
@synthesize idea;
...
- (id)init
{
    ...
    if (self) {
        ...
        phoneInvitees = [[NSMutableArray alloc] init];
        emailInvitees = [[NSMutableArray alloc] init];
    }
    return self;
}
@end
