...
@protocol CopingCardEditDelegate <NSObject>
@optional
...
@interface CopingCardEditContainerViewController : UIViewController<UIAlertViewDelegate, UIActionSheetDelegate, CopingCardEditorDelegate>
...
@property (strong, nonatomic) id <CopingCardEditDelegate> delegate;
