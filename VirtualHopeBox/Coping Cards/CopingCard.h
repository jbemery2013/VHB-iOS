...
@class CopingSkill, Symptom;

@interface CopingCard : NSManagedObject

@property (nonatomic, retain) NSString * problem;
@property (nonatomic, retain) NSDate * created;
@property (nonatomic, retain) NSSet *symptoms;
@property (nonatomic, retain) NSSet *copingSkills;
@end

@interface CopingCard (CoreDataGeneratedAccessors)
...
- (void)addCopingSkills:(NSSet *)values;
- (void)removeCopingSkills:(NSSet *)values;
