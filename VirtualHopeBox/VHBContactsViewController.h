...
@interface VHBContactsViewController : UIViewController <NSFetchedResultsControllerDelegate, MFMailComposeViewControllerDelegate, UITableViewDataSource, UITableViewDelegate,
ABPeoplePickerNavigationControllerDelegate, UIActionSheetDelegate, ABPersonViewControllerDelegate, UIAlertViewDelegate>
...
@property (strong, nonatomic) NSArray *hotlineNames, *hotlineNumbers, *hotlineAccessibilityNames;
