...
@interface CBChangeMusicViewController () {
    
}

@end

@implementation CBChangeMusicViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [CBMusicType nameForMusicType:(int)indexPath.row];
    return cell;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    [delegate musicChanged :(int)indexPath.row];
