...
static natural_t get_free_memory(void)
{
    ...
    /* Stats in bytes */
    int t = [NSString stringWithFormat:@"%li", (long)vm_stat.free_count * pagesize];
    natural_t mem_free = t;
    return mem_free;
}
...
- (int)getMemoryCount
{
    return [[NSString stringWithFormat:@"%li", (long)[[memCache allKeys] count]] intValue];
}
