...
@interface VHBQuotesSettingsViewController : VHBDarkTableViewController <UIPopoverControllerDelegate>

@property (strong, nonatomic) IBOutlet UIDatePicker *pickerView;
@property (strong, nonatomic) IBOutlet UIBarButtonItem *pickerDoneButton;
