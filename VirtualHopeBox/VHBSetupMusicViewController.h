...
@interface VHBSetupMusicViewController : UIViewController <UIActionSheetDelegate, MPMediaPickerControllerDelegate, VHBAudioReminderTableDelegate>
...
@property (strong, nonatomic) VHBAudioReminderViewController *audioTableController;
