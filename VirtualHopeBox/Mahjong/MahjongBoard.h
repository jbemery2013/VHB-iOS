...
@interface MahjongBoard : NSObject

@property (strong, nonatomic) MahjongPuzzle *puzzle;
@property (strong, nonatomic) NSMutableArray *tileSlots;
@property (strong, nonatomic) NSMutableArray *freeTileSlots;
