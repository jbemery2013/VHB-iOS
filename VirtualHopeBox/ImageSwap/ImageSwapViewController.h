...
@interface ImageSwapViewController : UIViewController <UIActionSheetDelegate, ImageSwapPuzzleDelegate>
@property (weak, nonatomic) IBOutlet UIBarButtonItem *menuButton;
@property (weak, nonatomic) IBOutlet UIBarButtonItem *contactsButton;
@property (weak, nonatomic) IBOutlet ImageSwapPuzzleView *puzzleView;
