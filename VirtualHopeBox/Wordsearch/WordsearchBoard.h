...
@interface WordsearchBoard : NSObject

typedef enum {NorthEast, SouthWest, NorthWest, SouthEast, West, North, East, South} WSDirection;

@property NSMutableArray *cells, *words;
@property int complexity, rows, columns;
